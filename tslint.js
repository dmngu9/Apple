module.exports = {
    ...
    rules: {
        // ========== CUSTOM RULES ==============
        // ensure that indexes do not contain anything other than import and export declarations
        'dumb-index-only': true,
        ...
        // Forces rxjs operators to be imported under epics/rxjs.tsx
        'rxjs-add': {
            options: [
                {
                    allowElsewhere: false,
                    allowUnused: false,
                    file: './src/epics/rxjs.tsx',
                },
            ],
            severity: 'error',
        },

        // Disable import from 'rxjs';
